    ...
    <section className='container m-auto p-15' id='sobre'>
      ...
      <div className='grid lg:grid-cols-3 gap-31 md:gap-45 items-center'>
        ...
        <article className='md:col-span-2'>
          ...
          <p className='mb-15'>Eu sou uma profissional formada em Análise e Desenvolvimento de Sistemas com dois anos de experiência na área de desenvolvimento de front-end. Meu interesse pela área surgiu durante o curso técnico em informática, e desde então, tenho me dedicado a me tornar uma referência na área.</p>
          <p className='mb-18'>Ao longo da minha trajetória, eu trabalhei com diversas tecnologias de desenvolvimento, mas minha especialidade é na programação reativa do React.js & Next.js. Sempre priorizando a performance e utilizando conceitos como SOLID, Mobile First, Atomic Design, já participei de entregas de produtos de alta qualidade no mercado, como Experimentador e Brandlovrs.</p>
