          ...
          <Slide direction='right' duration={600} triggerOnce={true}>
            ...
            <div className='flex items-center justify-between mt-15'>
              <div className='grid grid-cols-3 items-center'>
                <a href='https://www.linkedin.com/in/isabela-maria-ribeiro/' target='_blank' className='mr-8' title='linkedin' aria-label="linkedin da desenvolvedora">
                  <FaInstagram className='text-gray-900 text-22 hover:text-yellow transition-colors' />
                  <span className='hidden'>instagram</span>
                </a>
                <a href='https://www.instagram.com/isabela10015/' target='_blank' className='mr-8' title='instagram' aria-label="instagram da desenvolvedora">
                  <FaLinkedin className='text-gray-900 text-22 hover:text-yellow transition-colors' />
                  <span className='hidden'>linkedin</span>
                </a>
                <a href='mailto:dev@isabelamribeiro.com.br' target='_blank' className='mr-8' title='E-mail' aria-label="E-mail da desenvolvedora">
